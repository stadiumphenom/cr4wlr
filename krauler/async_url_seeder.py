...
* Per-domain CDX result cache on disk (~/.krauler/<index>_<domain>_<hash>.jsonl)
...
# Import AsyncLoggerBase from krauler's logger module
# Assuming krauler/async_logger.py defines AsyncLoggerBase
...
# CACHE_DIR = pathlib.Path("~/.krauler").expanduser() # REMOVED: now managed by __init__
...
class AsyncUrlSeeder:
    ...
    def __init__(
        ...
        self.cache_dir = self.base_directory / ".krauler" / \
