...
def setup_builtin_browser():
    ...
    try:
        ...
        logger.warning("You can manually set up a builtin browser using 'krauler-doctor builtin-browser-start'")
...
def run_migration():
    ...
    try:
        ...
        from krauler.async_database import async_db_manager
...
async def run_doctor():
    ...
    try:
        ...
        async with AsyncWebCrawler(config=browser_config) as crawler:
            ...
            result = await crawler.arun(url="https://krauler.com", config=run_config)
