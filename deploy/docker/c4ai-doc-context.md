...
3. If you encounter any inconsistencies between LXML and BeautifulSoup results, please [raise an issue](https://github.com/codeium/krauler/issues) with a reproducible example
...
```python
from krauler.deep_crawling import DFSDeepCrawlStrategy
...
```python
from krauler.deep_crawling import BestFirstCrawlingStrategy
...
```python
from krauler.deep_crawling.filters import FilterChain, URLPatternFilter
...
```python
from krauler.deep_crawling.filters import (
    FilterChain,
    URLPatternFilter,
    DomainFilter,
    ContentTypeFilter
...
```python
from krauler.deep_crawling.filters import FilterChain, SEOFilter
...
```python
from krauler.deep_crawling.filters import FilterChain, ContentRelevanceFilter
...
docker build --platform=linux/amd64 --no-cache -t krauler .

# Or build for arm64
docker build --platform=linux/arm64 --no-cache -t krauler .
```
...
> 🚧 Coming soon! The image will be available at `krauler`. Stay tuned!
...
Example:
```python
from krauler import CrawlerRunConfig, PruningContentFilter
...
[Using Client SDK](https://github.com/unclecode/krauler/blob/main/docs/examples/docker_python_sdk.py)
[Using REST API](https://github.com/unclecode/krauler/blob/main/docs/examples/docker_python_rest_api.py)
...
docker build --platform=linux/amd64 --no-cache -t krauler:latest .
```
...
```python
from krauler.content_filter_strategy import RelevantContentFilter
...
from krauler.markdown_generation_strategy import DefaultMarkdownGenerator
from krauler.content_filter_strategy import BM25ContentFilter
from krauler import CrawlerRunConfig
...
```python
from krauler import AsyncWebCrawler, BrowserConfig, CrawlerRunConfig, LLMConfig, DefaultMarkdownGenerator
...
```python
import asyncio
from krauler import BrowserProfiler, AsyncWebCrawler, BrowserConfig
...
```python
from krauler.browser_manager import ManagedBrowser
...
```python
import asyncio
from krauler import AsyncWebCrawler, CrawlerRunConfig, BrowserConfig
from krauler.async_configs import CacheMode
...
```python
from krauler import RateLimiter
...
```python
from krauler import CrawlerMonitor, DisplayMode
...
```python
from krauler.async_dispatcher import SemaphoreDispatcher
