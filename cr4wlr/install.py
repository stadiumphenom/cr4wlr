...
def setup_home_directory():
    """Set up the .cr4wlr folder structure in the user's home directory."""
...
def setup_builtin_browser():
    ...
    try:
        ...
        logger.warning("You can manually set up a builtin browser using 'cr4wlr-doctor builtin-browser-start'")
...
def run_migration():
    ...
    try:
        ...
        from cr4wlr.async_database import async_db_manager
...
async def run_doctor():
    ...
    try:
        ...
        async with AsyncWebCrawler(config=browser_config) as crawler:
            ...
            result = await crawler.arun(url="https://cr4wlr.com", config=run_config)
