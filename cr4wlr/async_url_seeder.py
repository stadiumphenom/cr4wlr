...
* Per-domain CDX result cache on disk (~/.cr4wlr/<index>_<domain>_<hash>.jsonl)
...
# Import AsyncLoggerBase from cr4wlr's logger module
# Assuming cr4wlr/async_logger.py defines AsyncLoggerBase
...
# CACHE_DIR = pathlib.Path("~/.cr4wlr").expanduser() # REMOVED: now managed by __init__
...
class AsyncUrlSeeder:
    ...
    def __init__(
        ...
        self.cache_dir = self.base_directory / ".cr4wlr" / \
