...
class NaivePDFProcessorStrategy(PDFProcessorStrategy):
    def __init__(self, image_dpi: int = 144, image_quality: int = 85, extract_images: bool = True, 
        ...
        try:
            ...
            raise ImportError("PyPDF2 is required for PDF processing. Install with 'pip install cr4wlr[pdf]'")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("PyPDF2 is required for PDF processing. Install with 'pip install cr4wlr[pdf]'")
        exit(1)
