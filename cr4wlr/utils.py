...
class VersionManager:
    def __init__(self):
        self.home_dir = Path.home() / ".cr4wlr"
...
class RobotsParser:
    ...
    def __init__(self, cache_dir=None, cache_ttl=None):
        self.cache_dir = cache_dir or os.path.join(get_home_folder(), ".cr4wlr", "robots")
...
def get_home_folder():
    ...
    2. Creates `.cr4wlr` and its subdirectories (`cache`, `models`) if they don't exist.
...
async def get_chromium_path(browser_type) -> str:
    ...
    async with async_playwright() as p:
        ...
        # Save the path int the cr4wlr home folder
        home_folder = get_home_folder()
...
def configure_windows_event_loop():
    ...
    Example:
        ```python
        from cr4wlr.async_configs import configure_windows_event_loop
    ...
    # Default: use sentence-transformers
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install it with: pip install 'cr4wlr[transformer]' or pip install sentence-transformers"
            )
