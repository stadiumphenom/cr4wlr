...
# Create the .krauler folder in the user's home directory if it doesn't exist
...
try:
    with open("krauler/__version__.py") as f:
        for line in f:
...
setup(
    ...
    url="https://github.com/unclecode/krauler",
    author="Unclecode",
    author_email="unclecode@kidocode.com",
    license="Apache-2.0",
    packages=find_packages(),
    package_data={"krauler": ["js_snippet/*.js"]},
    classifiers=[
