...
- **Automatic Installation**: `krauler-setup` installs all necessary browser dependencies
...
```python
from krauler import AsyncWebCrawler, BrowserConfig, UndetectedAdapter
from krauler.async_crawler_strategy import AsyncPlaywrightCrawlerStrategy
...
from krauler import PlaywrightAdapter
