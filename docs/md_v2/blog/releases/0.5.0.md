...
```python
import time
from cr4wlr import AsyncWebCrawler, CrawlerRunConfig, BFSDeepCrawlStrategy
from cr4wlr.content_scraping_strategy import LXMLWebScrapingStrategy
from cr4wlr.deep_crawling import DomainFilter, ContentTypeFilter, FilterChain, URLPatternFilter, KeywordRelevanceScorer, BestFirstCrawlingStrategy
import asyncio
...
```python
from cr4wlr import AsyncWebCrawler, CrawlerRunConfig, MemoryAdaptiveDispatcher
import asyncio
...
async def batch_mode():
    async with AsyncWebCrawler() as crawler:
        results = await crawler.arun_many(
            urls=["https://docs.cr4wlr.com", "https://github.com/unclecode/cr4wlr"],
...
```python
from cr4wlr import AsyncWebCrawler, CrawlerRunConfig, HTTPCrawlerConfig
